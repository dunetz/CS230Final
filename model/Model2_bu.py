...
from keras.layers import Conv1D, Conv2D, MaxPooling2D, Flatten, Reshape, BatchNormalization
...
#
# second conv2d-LSTM model - increase number of LSTM units to 100
#
